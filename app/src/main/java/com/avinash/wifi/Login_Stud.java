...
public class Login_Stud extends AppCompatActivity {
    ...
    public void SignUp(View view) {
        startActivity(new Intent(this,SignUp_Stud.class));
    }
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    if(user.isEmailVerified()){
                        startActivity(new Intent(Login_Stud.this,StudentAct.class));
                        progressBar.setVisibility(View.GONE);
                    }else {
                        progressBar.setVisibility(View.GONE);
                        user.sendEmailVerification();
                        Toast.makeText(Login_Stud.this, "Check your email to verify your account", Toast.LENGTH_LONG).show();
                    }
                }else {
                    Toast.makeText(Login_Stud.this, "Failed to login! check email & password", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void Go(View view) {
        startActivity(new Intent(Login_Stud.this,SignUp_Stud.class));
    }
}